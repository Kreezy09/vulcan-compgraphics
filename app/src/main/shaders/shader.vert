...
vec2 positions[12] = vec2[](
    vec2(0.2, 0.4), //chini to the left
    vec2(0.8, 0.4),  //chini to the right
    vec2(1.0, 0.8),   // katkati to the right
    vec2(1.0, 0.8),   // katkati to the right
    vec2(0.3, 1.2), // Bottom left y juu
    vec2(0.7, 1.2),   // y juu to the right
    vec2(0.7, 1.2),   // y juu to the right
    vec2(0.0, 0.8),   //katikati to the left
